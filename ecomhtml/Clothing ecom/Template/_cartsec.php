...
<!-- Shopping cart section  -->
    <section id="cart" class="py-5 mt-10">
                    ...
                    <div class="col-sm-9">
                        <!-- cart item -->
                            <div class="row border-top py-3 mt-3">
                                <div class="col-sm-2">
                                    <img src="eimages/m1.png" style="height: 120px;" alt="cart1" class="img-fluid">
                                </div>
                                <div class="col-sm-8">
                        ...
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="eimages/w3.png" style="height: 120px;" alt="cart1" class="img-fluid">
                            </div>
                            <div class="col-sm-8">
                                <h5 class="font-baloo font-size-20">Samsung Galaxy 10</h5>
                                <small>by Samsung</small>
